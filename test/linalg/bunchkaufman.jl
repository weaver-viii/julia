...
@testset "$eltya argument A" for eltya in (Float32, Float64, Complex{Float32}, Complex{Float64}, Int)
    ...
    for (a, a2, aher, apd) in ((a, a2, aher, apd),
        ...
        @testset "$eltyb argument B" for eltyb in (Float32, Float64, Complex{Float32}, Complex{Float64}, Int)
