...
function test_intersection()
    ...
    @testintersect(Tuple{Type{Vector{Complex{Float64}}}, AbstractVector},
                   (@UnionAll T @UnionAll S @UnionAll N Tuple{Type{Array{T,N}}, Array{S,N}}),
                   Tuple{Type{Vector{Complex{Float64}}},Vector})

    @testintersect(Tuple{Type{Vector{Complex{Float64}}}, AbstractArray},
                   (@UnionAll T @UnionAll S @UnionAll N Tuple{Type{Array{T,N}}, Array{S,N}}),
                   Tuple{Type{Vector{Complex{Float64}}},Vector})
